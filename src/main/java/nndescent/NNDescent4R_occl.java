...
import types.NodeDistance;
import types.NodeVectorDistance;
import types.Pair;
import writables.KNNSimpleItemWritable;
import writables.NNItemDistanceWritable;
import writables.NNSimpleWritable;
import writables.NodeOrNodeVectorWritable;
import writables.NodeVectorDistanceWritable;
import writables.NodeVectorOrSimpleWritable;
import writables.NodeVectorWritable;

public class NNDescent4R_occl extends Configured implements Tool {

    long mor, mob;

    public static void main(String[] args) throws Exception {
        ToolRunner.run(new NNDescent4R_occl(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        while(numChanges > 0)
        {
            ...
            System.out.printf("step2\t%d\t%d\t%d\t%d\n", round, (System.currentTimeMillis() - t), mor, mob);

            t = System.currentTimeMillis();
            runStep3(roundStep2Path, roundStep3Path, round);
            System.out.printf("step3\t%d\t%d\t%d\t%d\n", round, (System.currentTimeMillis() - t), mor, mob);

            t = System.currentTimeMillis();
            Pair counts = runStep4(roundStep3Path, roundOutputPath, round);
            numChanges = counts.first;
            scans += counts.second;
            System.out.printf("step4\t%d\t%d\t%d\t%d\t%d\n", round, (System.currentTimeMillis() - t), mor, mob, numChanges);
        ...
        int numVector = Integer.parseInt(args[2]);
        System.out.println("scan " + (float)(scans * 2.0 / numVector / (numVector-1)));
...
//    Init 1
    ...
    public void initGraphStep1(String input, String output) throws Exception
    {
        ...
        job.setJarByClass(NNDescent4R_occl.class);
    ...
    public static class GraphStep1Mapper extends Mapper<Object, Text, IntWritable, NodeOrNodeVectorWritable>
    {
        ...
        protected void map(Object key, Text value,
                           Mapper<Object, Text, IntWritable, NodeOrNodeVectorWritable>.Context context)
                throws IOException, InterruptedException {
    ...
    public static class GraphStep1Reducer extends Reducer<IntWritable, NodeOrNodeVectorWritable, IntWritable, NodeVectorWritable>
    {
        ...
        protected void setup(
                Reducer<IntWritable, NodeOrNodeVectorWritable, IntWritable, NodeVectorWritable>.Context context)
                throws IOException, InterruptedException {
        ...
        @Override
        protected void reduce(IntWritable key, Iterable<NodeOrNodeVectorWritable> values,
                              Reducer<IntWritable, NodeOrNodeVectorWritable, IntWritable, NodeVectorWritable>.Context context)
                throws IOException, InterruptedException {
...
//    Init 2
    ...
    public static class GraphStep2Mapper extends Mapper<IntWritable, NodeVectorWritable, IntWritable, NodeVectorWritable>
    {
        ...
        @Override
        protected void map(IntWritable key, NodeVectorWritable value,
                           Mapper<IntWritable, NodeVectorWritable, IntWritable, NodeVectorWritable>.Context context)
                throws IOException, InterruptedException {
    ...
    public static class GraphStep2Reducer extends Reducer<IntWritable, NodeVectorWritable, NodeVectorWritable, KNNSimpleItemWritable>
    {
        ...
        @Override
        protected void reduce(IntWritable key, Iterable<NodeVectorWritable> values,
                              Reducer<IntWritable, NodeVectorWritable, NodeVectorWritable, KNNSimpleItemWritable>.Context context)
                throws IOException, InterruptedException {
            ...
            for(i = 0 ; i < k ; i++)
            {
                knnsw.distances[i] = Distances.l1(uw.vector, vectors[i]);
            }
...
//    Step 1
    ...
    {
        Job job = Job.getInstance(getConf(), "4R_occl : Round(" + round + ") : Step1");
        job.setJarByClass(NNDescent4R_occl.class);
    ...
    public static class Step1Mapper extends Mapper<NodeVectorWritable, KNNSimpleItemWritable, IntWritable, NodeVectorOrSimpleWritable>
    {
        ...
        @Override
        protected void setup(
                Mapper<NodeVectorWritable, KNNSimpleItemWritable, IntWritable, NodeVectorOrSimpleWritable>.Context context)
                throws IOException, InterruptedException {
        ...
        @Override
        protected void map(NodeVectorWritable key, KNNSimpleItemWritable value,
                           Mapper<NodeVectorWritable, KNNSimpleItemWritable, IntWritable, NodeVectorOrSimpleWritable>.Context context)
                throws IOException, InterruptedException {
    ...
    public static class Step1Reducer extends Reducer<IntWritable, NodeVectorOrSimpleWritable, NodeVectorWritable, NNSimpleWritable>
    {
        ...
        @Override
        protected void setup(
                Reducer<IntWritable, NodeVectorOrSimpleWritable, NodeVectorWritable, NNSimpleWritable>.Context context)
                throws IOException, InterruptedException {
...
//   Step 2
    ...
    {
        Job job = Job.getInstance(getConf(), "4R_occl : Round(" + round + ") : Step2");
        job.setJarByClass(NNDescent4R_occl.class);
    ...
    public static class Step2Mapper extends Mapper<NodeVectorWritable, NNSimpleWritable, IntWritable, NodeVectorDistanceWritable>
    {
        ...
        @Override
        protected void setup(
                Mapper<NodeVectorWritable, NNSimpleWritable, IntWritable, NodeVectorDistanceWritable>.Context context)
                throws IOException, InterruptedException {
        ...
        @Override
        protected void map(NodeVectorWritable key, NNSimpleWritable value,
                           Mapper<NodeVectorWritable, NNSimpleWritable, IntWritable, NodeVectorDistanceWritable>.Context context)
                throws IOException, InterruptedException {
    ...
    public static class Step2Reducer extends Reducer<IntWritable, NodeVectorDistanceWritable, IntWritable, NNItemDistanceWritable>
    {
        ...
        @Override
        protected void reduce(IntWritable key, Iterable<NodeVectorDistanceWritable> values,
                              Reducer<IntWritable, NodeVectorDistanceWritable, IntWritable, NNItemDistanceWritable>.Context context)
                throws IOException, InterruptedException {
...
//  Step 3
    ...
    {
        Job job = Job.getInstance(getConf(), "4R_occl : Round(" + round + ") : Step3");
        job.setJarByClass(NNDescent4R_occl.class);
    ...
    public static class Step3Mapper extends Mapper<IntWritable, NNItemDistanceWritable, IntWritable, NodeVectorDistanceWritable>
    {
        ...
        @Override
        protected void setup(
                Mapper<IntWritable, NNItemDistanceWritable, IntWritable, NodeVectorDistanceWritable>.Context context)
                throws IOException, InterruptedException {
        ...
        @Override
        protected void map(IntWritable key, NNItemDistanceWritable value,
                           Mapper<IntWritable, NNItemDistanceWritable, IntWritable, NodeVectorDistanceWritable>.Context context)
                throws IOException, InterruptedException {
...
//  Step 4
    ...
    public Pair runStep4(String inputPath, String outputPath, int round) throws Exception
    {
        Job job = Job.getInstance(getConf(), "4R_occl : Round(" + round + ") : Step4");
        job.setJarByClass(NNDescent4R_occl.class);
        ...
        return new Pair(job.getCounters().findCounter(NNDCounters.NUM_CHANGES).getValue(), job.getCounters().findCounter(NNDCounters.NUM_SCANS).getValue());
    }
    ...
    public static class Step4Mapper extends Mapper<IntWritable, NNItemDistanceWritable, IntWritable, NodeVectorOrSimpleWritable>
    {
        ...
        @Override
        protected void setup(
                Mapper<IntWritable, NNItemDistanceWritable, IntWritable, NodeVectorOrSimpleWritable>.Context context)
                throws IOException, InterruptedException {
        ...
        protected void map(IntWritable key, NNItemDistanceWritable value,
            ...
            for(int i = 0 ; i < value.numNeighbors ; i++)
            {
                ...
                for(int j = i + 1 ; j < value.numNeighbors ; j++)
                {
                    ...
                    {
                        nvosw.set(Distances.l1(value.vectors.get(i), value.vectors.get(j)), true);
                        counter++;
            ...
            context.getCounter(NNDCounters.NUM_SCANS).increment(counter);
        }
    }
    ...
    public static class Step4Reducer extends Reducer<IntWritable, NodeVectorOrSimpleWritable, NodeVectorWritable, KNNSimpleItemWritable>
    {
        ...
        protected void setup(
            ...
            Configuration conf = context.getConfiguration();
            k = conf.getInt("k", 0);
            KNNSimpleItemWritable.numNeighbors = conf.getInt("k", 0);
            NodeVectorOrSimpleWritable.dimVector = conf.getInt("dimVector", 0);
            NodeVectorWritable.dimVector = conf.getInt("dimVector", 0);
            knnsw.setup();
        }
...
//    Result
    ...
    public static class ResultMapper extends Mapper<NodeVectorWritable, KNNSimpleItemWritable, IntWritable, IntWritable>
    {
        ...
        @Override
        protected void setup(
                Mapper<NodeVectorWritable, KNNSimpleItemWritable, IntWritable, IntWritable>.Context context)
                throws IOException, InterruptedException {
